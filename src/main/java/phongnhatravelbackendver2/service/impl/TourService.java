...
public class TourService implements ITourService {
	...
	@Override
	public List<ToursDTO> searchTours(String tourName, String categoryCode, String endDate, String startDate,
			Long startPrice, Long endPrice) {
		List<ToursEntity> listTourEntity = tourRepository.searchTours(tourName == "" ? "tour" : tourName,
				categoryCode == "" ? "-" : categoryCode, endDate, startDate, startPrice, endPrice);
//		List<ToursEntity> listTourEntity = tourRepository.searchTours(endDate, startDate, startPrice, endPrice);
//		List<ToursEntity> listTourEntity = tourRepository.searchTours();

		return tourConverter.toListDTO(listTourEntity);
	}
}
